  ...
  <script src="/js/anos-experiencia.js" defer></script>"""
    ...
    <section class="qs-bento">
      <div class="container qs-bento__grid">
        ...
        <!-- PLACEHOLDER: recortes do print. Trocar pelas fotos originais. -->
        <div class="qs-bento__cell qs-bento__cell--foto qs-bento__cell--f1">
          <img src="/images/quem-somos/PLACEHOLDER-mosaico-1-fachada.jpg" alt="Fachada da sede da WM Trading" />
        </div>
        <div class="qs-bento__cell qs-bento__cell--foto qs-bento__cell--f2">
          <img src="/images/quem-somos/PLACEHOLDER-mosaico-2-reuniao.jpg" alt="Equipe da WM Trading em reunião" />
        </div>
        <div class="qs-bento__cell qs-bento__cell--foto qs-bento__cell--f3">
          <img src="/images/quem-somos/PLACEHOLDER-mosaico-3-openspace.jpg" alt="Escritório da WM Trading em open space" />
        </div>
        <div class="qs-bento__cell qs-bento__cell--foto qs-bento__cell--f4">
          <img src="/images/quem-somos/PLACEHOLDER-mosaico-4-lounge.jpg" alt="Área de convivência da sede da WM Trading" />
        </div>
    ...
    <section class="qs-carreiras">
      <div class="container qs-carreiras__grid">
        ...
        <!-- PLACEHOLDER: recorte do print. Trocar pela foto original do time. -->
        <img src="/images/quem-somos/PLACEHOLDER-time-carreiras.jpg" alt="Equipe da WM Trading reunida em confraternização" />
      </div>
    </section>
    """
