    ...
    <section class="qs-bento">
      <div class="container qs-bento__grid">
        ...
        <div class="qs-bento__cell qs-bento__cell--foto qs-bento__cell--f1">
          <img src="/images/quem-somos/mosaico-1-recepcao.webp" alt="Recepção da sede da WM Trading, com o logo e o slogan We Make it better na parede" width="660" height="500" loading="lazy" />
        </div>
        <div class="qs-bento__cell qs-bento__cell--foto qs-bento__cell--f2">
          <img src="/images/quem-somos/mosaico-2-reuniao.webp" alt="Equipe da WM Trading em reunião na sala de convenções" width="660" height="500" loading="lazy" />
        </div>
