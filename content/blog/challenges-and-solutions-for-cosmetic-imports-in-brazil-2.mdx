...
Additionally, companies looking to sell these products must have specific certifications and authorizations. **You can check the requirements to import these products with WM on our Cosmetics** [**segment page**](/segmentos/cosmeticos/).
...
With WM, your company can import cosmetics either through the [order-based](/importacao-por-encomenda/) or [account-and-order modality](/importacao-por-conta-e-ordem/), aiming to reduce the ICMS rate through **tax benefits like those in Espírito Santo**.
...
**Looking to start a cosmetics import project? [Get in touch with us](/fale-conosco/)!**
