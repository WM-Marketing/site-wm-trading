...
categories:
  - "Cosmetics"
cover: "/wp-content/uploads/2024/10/BANNERS-PARA-BLOGS-E-BOOKS-E-E-MAILS-v2.webp"
lang: "en"
...
Additionally, companies looking to sell these products must have specific certifications and authorizations. **You can check the requirements to import these products with WM on our Cosmetics** [**segment page**](/segmentos/cosmeticos.html).
...
With WM, your company can import cosmetics either through the [order-based](/importacao-por-encomenda.html) or [account-and-order modality](/importacao-por-conta-e-ordem.html), aiming to reduce the ICMS rate through **tax benefits like those in Espírito Santo**.

**READ MORE: [How to Import in Espírito Santo with Cost Reduction](/blog/importar-espirito-santo.html)**
...
**Constantly monitoring the status of the LI with [ANVISA](/blog/importar-produtos-regulados-anvisa.html) and ensuring that all requirements are met is essential for successful product nationalization.**
...
Our **extensive reach across 12 Brazilian states and seven tax benefits** that reduce the ICMS rate make importing cosmetics more cost-effective for your company.
...
**Looking to start a cosmetics import project? [Get in touch with us](/fale-conosco.html)!**
